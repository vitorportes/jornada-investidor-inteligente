...
const modules: Module[] = [
  ...
  },
  {
    ...
    description: "Explore o universo dos investimentos: renda fixa, ações, fundos, imóveis, criptomoedas e muito mais.",
  ...
  },
  {
    ...
    description: "Invista em imóveis de forma inteligente e acessível, e aprenda a gerar renda passiva todos os meses.",
  ...
  },
  {
    ...
    description: "Transforme seus investimentos em uma fonte de renda recorrente e construa sua liberdade financeira.",
...
const ModuleCard = ({
  ...
  const HIGHLIGHT_COLOR_CLASS = "text-[#e3b061]"

  return (
    <Card className="group relative flex flex-col overflow-hidden rounded-xl border border-white/10 bg-white/5 shadow-lg transition-all duration-300 hover:border-white/20 hover:shadow-[#e3b061]/10">
      ...
      >
        ...
        <motion.div animate={{ rotate: isExpanded ? 180 : 0 }} transition={{ duration: 0.3 }}>
          <ChevronDown
            className={`h-5 w-5 flex-shrink-0 ${isExpanded ? HIGHLIGHT_COLOR_CLASS : "text-gray-400"} transition-colors`}
          />
        </motion.div>
      </CardHeader>
