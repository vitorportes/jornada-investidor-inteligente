...
const pageData = {
  hero: {
    ...
    subtitle:
      "Adquira nossos e-books e comece sua jornada rumo à independência financeira. Conteúdo prático e objetivo para transformar sua relação com o dinheiro.",
  },
  ebooks: [
    {
      id: 1,
      icon: BookOpen,
      title: "Aprenda a Investir em Renda Fixa",
      description: "Guia completo para investimentos seguros e previsíveis em renda fixa.",
      gradient: "from-[#e3b061] to-[#d4a259]",
    },
    {
      id: 2,
      icon: BookOpen,
      title: "Como investir em Ações",
      description: "Estratégias e fundamentos para investir na bolsa de valores com segurança.",
    ...
    },
    {
      ...
      description: "Base sólida para organizar suas finanças e tomar decisões inteligentes.",
    ...
    },
    {
      ...
      description: "Como investir em imóveis através dos FIIs e gerar renda passiva.",
    ...
    },
    {
      ...
      description: "Desenvolva a psicologia certa para investir com disciplina e estratégia.",
      gradient: "from-teal-500 to-cyan-500",
    },
    {
      id: 6,
      icon: BookOpen,
      title: "Como se livrar das Dívidas",
      description: "Estratégias práticas para quitar dívidas e reorganizar sua vida financeira.",
    ...
    },
    {
      ...
      description: "Guia completo para investir nos títulos públicos do governo brasileiro.",
...
const EbookCard = ({ ebook, index }: { ebook: (typeof pageData.ebooks)[0]; index: number }) => {
  ...
  return (
    <MotionWrapper delay={index * 0.05}>
      <Card className="group flex h-full flex-col overflow-hidden border-white/10 bg-white/[.03] transition-all duration-300 hover:border-[#e3b061]/50 hover:bg-white/5 hover:-translate-y-2">
        <CardContent className="flex flex-grow flex-col p-6 text-center">
          <div className="relative mb-6">
            <div
              className={`absolute -inset-2 rounded-2xl bg-gradient-to-br ${ebook.gradient} opacity-0 blur-xl transition-all duration-500 group-hover:opacity-20`}
            />
            <div
              className={`relative mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br ${ebook.gradient} shadow-lg shadow-black/20`}
            >
              <Icon className="h-8 w-8 text-white" />
            </div>
          </div>
          <div className="flex-grow">
            <h3 className="mb-2 text-lg font-bold text-white transition-colors duration-300 group-hover:text-[#e3b061]">
              {ebook.title}
            </h3>
    ...
    <div className="min-h-screen bg-gray-950 text-white selection:bg-cyan-500/30">
      ...
      <main className="relative z-10 pt-24 sm:pt-28">
        ...
        <section className="mx-auto max-w-7xl px-6 py-16 text-center lg:px-8">
          <MotionWrapper>
            <BookOpen className="mx-auto h-14 w-14 text-[#e3b061]" />
            <h1 className="mt-6 text-4xl font-extrabold tracking-tight text-white sm:text-5xl">
              {pageData.hero.title}
            </h1>
            <p className="mt-6 max-w-3xl mx-auto text-lg leading-8 text-gray-300">{pageData.hero.subtitle}</p>
          </MotionWrapper>
        </section>
              ...
              <div className="rounded-[23px] bg-gray-950/90 px-6 py-24 sm:px-16">
                <MotionWrapper>
                  <div className="mx-auto max-w-2xl">
                    <GraduationCap className="mx-auto h-12 w-12 text-[#e3b061]" />
                    ...
                    <div className="mt-10 flex items-center justify-center">
                      <Button
                        ...
                        asChild
                      >
                        <Link href={pageData.cta.buttonLink}>{pageData.cta.buttonText}</Link>
                      </Button>
                    </div>
                  </div>
                </MotionWrapper>
