...
const AnimatedBackground = () => (
  ...
  >
    ...
    <div
      className="absolute inset-0 bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:36px_36px] [mask-image:radial-gradient(ellipse_50%_50%_at_50%_50%,#000_60%,transparent_100%)]"
    />
  </div>
)

export default function CTASection() {
  const HIGHLIGHT_COLOR = "text-cyan-400"
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-300 max-w-3xl mx-auto">
            A <span className="font-bold text-white">Jornada Investidor Inteligente</span> é o único método passo a passo que ensina você a dominar seus investimentos, mesmo começando do <span className="font-bold text-white">absoluto zero</span>.
          </p>
        </div>
            ...
            <div className="relative aspect-[16/9] overflow-hidden rounded-lg sm:rounded-xl shadow-2xl">
              ...
              <div className="absolute bottom-0 right-0 p-2 sm:top-0 sm:bottom-auto sm:p-4">
                <div className="backdrop-blur-md bg-green-500/80 px-2.5 py-1 sm:px-3 sm:py-1.5 rounded-full text-center">
                  <span className="text-white font-bold text-[10px] leading-none sm:text-sm">Tranquilidade financeira</span>
                </div>
              </div>
        ...
        <div className="mt-16 mx-auto max-w-3xl text-center">
            <p className="text-lg leading-relaxed text-gray-300">
                ...
                <span className={`${HIGHLIGHT_COLOR} font-semibold`}>assumir o controle do seu dinheiro</span> e começar hoje sua transformação financeira.
            </p>
        </div>
