        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          ...
          <Card className="group backdrop-blur-lg bg-white/5 border border-white/10 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 cursor-pointer overflow-hidden">
            <CardContent className="p-8 text-center">
              ...
              <h3 className="font-montserrat font-bold text-xl text-white mb-3 group-hover:text-[#e3b061] transition-colors duration-300">
                Instagram
              </h3>
              ...
              <a
                ...
                className="inline-flex items-center text-[#e3b061] font-semibold text-sm hover:text-white transition-colors duration-300"
              >
